...
map<uint256, CBlockIndex*> mapBlockIndex;
 uint256 hashGenesisBlock("0x00000c1eaf472e822cff4380ccfb202d02e4acd8b00859232d695aa895584b38");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // TokyoCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TokyoCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000c1eaf472e822cff4380ccfb202d02e4acd8b00859232d695aa895584b38");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1431273177;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1327534;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TokyoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TokyoCoinCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("TokyoCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("TokyoCoin-miner");
    ...
    try { loop {
        ...
        printf("Running TokyoCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("TokyoCoinMiner terminated\n");
        throw;
    }
}
